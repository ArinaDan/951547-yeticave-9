...
<main class="container">
    <section class="promo">
        ...
        <?php foreach ($categories as $option): ?>
            <li class="promo__item promo__item--boards">
                <a class="promo__link" href="pages/all-lots.html"><?=$option;?></a>
        <?php endforeach; ?>
            </li>
        </ul>
    </section>
    <section class="lots">
        ...
        <ul class="lots__list">
            <?php foreach ($lots as $option): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$option['image']; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$option['category']; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$option['title'];?></a></h3>
